...
static const char *altbarcmd =
    "$HOME/.config/user/scripts/bar.sh"; /* Alternate bar launch command */
...
static const char *screenshotcmd[] = {
    "/bin/sh", "-c", "maim -s | xclip -selection clipboard -t image/png", NULL};
...
static Key keys[] = {
    ...
    {MODKEY, XK_space, togglefloatingandarrange, {0}},
    ...
    {0,
     ...
     spawn,
     {.v = (const char *[]){"pactl", "set-sink-volume", "@DEFAULT_SINK@", "+3%",
                            NULL}}},
    {0,
